...
(function ($) {
  ...
  // Debug: Vanilla JS event listener
  document.querySelectorAll('.tp-btn-square').forEach((button) => {
    button.addEventListener('click', function (e) {
      console.log(
        'Book Now button clicked (vanilla JS)! href: ' +
          this.getAttribute('href')
      );
    });
  });

  // Debug: jQuery event listener
  $('.tp-btn-square').on('click', function (event) {
    console.log(
      'Book Now button clicked (jQuery)! href: ' + $(this).attr('href')
    );
  });
  ////////////////////////////////////////////////////
  // 01. theme-js
